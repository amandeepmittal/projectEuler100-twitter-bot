// Implementation of #ProjectEuler100 Twitter bot
console.log('==== Welcome #ProjectEuler100 Twitter Bot ====')
  ...
  TwitterBot.get('search/tweets', params, (err, data) => {
    ...
    if (!err) {
      ...
      if (typeof randomTweet != 'undefined') {
        TwitterBot.post('favorites/create', { id: randomTweet.id_str }, (err, response) => {
          if (response) {
